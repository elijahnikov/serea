...
import { respondToInviteAction } from "~/actions/members/respond";
import type { ListInvitesForUserReturnType } from "~/queries/members/list-invites-for-user";

export default function Invites({
	invites,
}: { invites: ListInvitesForUserReturnType }) {
	const respondAction = useAction(respondToInviteAction);
					...
					<div className="flex items-center gap-2" key={invite.id}>
						...
						<div>
							<div className="font-medium leading-snug">
								...
								<span className="text-neutral-500"> invited you to join </span>
