...
exports.useFieldArray = exports.FormField = exports.FormMessage = exports.FormDescription = exports.FormControl = exports.FormLabel = exports.FormItem = exports.Form = exports.useFormField = exports.useForm = void 0;
var React = require("react");
var zod_1 = require("@hookform/resolvers/zod");
var react_slot_1 = require("@radix-ui/react-slot");
var react_hook_form_1 = require("react-hook-form");
var ui_1 = require("@serea/ui");
var label_1 = require("./label");
var useForm = function (props) {
    var form = (0, react_hook_form_1.useForm)(__assign(__assign({}, props), { resolver: (0, zod_1.zodResolver)(props.schema, undefined) }));
    return form;
};
...
var FormItem = React.forwardRef(function (_a, ref) {
    ...
    return (<FormItemContext.Provider value={{ id: id }}>
      <div ref={ref} className={(0, ui_1.cn)("space-y-2", className)} {...props}/>
...
var FormLabel = React.forwardRef(function (_a, ref) {
    ...
    return (<label_1.Label ref={ref} className={(0, ui_1.cn)(error && "text-destructive", className)} htmlFor={formItemId} {...props}/>);
});
...
var FormDescription = React.forwardRef(function (_a, ref) {
    ...
    return (<p ref={ref} id={formDescriptionId} className={(0, ui_1.cn)("text-[0.8rem] text-muted-foreground", className)} {...props}/>);
});
...
var FormMessage = React.forwardRef(function (_a, ref) {
    ...
    return (<p ref={ref} id={formMessageId} className={(0, ui_1.cn)("text-[0.8rem] font-medium text-destructive", className)} {...props}>
      {body}
    </p>);
});
...
Object.defineProperty(exports, "useFieldArray", { enumerable: true, get: function () { return react_hook_form_2.useFieldArray; } });
