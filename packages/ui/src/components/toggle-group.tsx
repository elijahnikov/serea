		...
		return (
			<ToggleGroupContext.Provider value={{ disabled, orientation, size }}>
				...
				<ToggleGroupPrimitive.Root
					ref={ref}
					className={cn(
						"dark:shadow:none inline-flex flex-wrap items-stretch divide-surface-100 rounded-lg shadow-wg-xs",
	...
	return (
		...
		>
			<Toggle
				asChild={asChild}
				className={cn(
					"flex items-center rounded-none border border-surface-200 bg-clip-padding focus-visible:z-10 focus-visible:-outline-offset-1 data-[state=on]:bg-surface-100",
					className,
					orientation === "horizontal"
